...
import { createApp } from './../libs/vue-esm.js?ver=3.1.11';
...
//Import Vue modules
import * as uipAppDropdown from './modules/uip-dropdown.min.js?ver=3.1.11';
import * as uipAppMultiSelect from './modules/uip-multiselect.min.js?ver=3.1.11';
import * as uipAppUserMultiSelect from './modules/uip-user-role-multiselect.min.js?ver=3.1.11';
import * as uipAppAccordion from './modules/uip-accordion.min.js?ver=3.1.11';
import * as uipAppSwitchToggle from './modules/uip-switch-toggle.min.js?ver=3.1.11';
import * as uipAppTooltip from './modules/uip-tooltip.min.js?ver=3.1.11';
import * as uipAppChartLoading from './modules/uip-loading-chart.min.js?ver=3.1.11';
import * as uipAppOffcanvas from './modules/uip-offcanvas.min.js?ver=3.1.11';
import * as uipAppBlockContainer from './modules/uip-prod-block-container.min.js?ver=3.1.11';
import * as uipAppContentArea from './modules/uip-content-area.min.js?ver=3.1.11';
import * as uipAppChart from './modules/uip-chart.min.js?ver=3.1.11';
import * as uipAppModal from './modules/uip-modal.min.js?ver=3.1.11';
import * as uipAppSaveButton from './modules/uip-save-button.min.js?ver=3.1.11';
import * as uipAppColorPicker from './options/uip-color-picker.min.js?ver=3.1.11';

//Import main ui view
import * as uipMainView from './modules/uip-app-view.min.js?ver=3.1.11';
