  ...
  return {
    ...
    data: function () {
      return {
        ...
        animationClass: 'uip-scale-in-top',
      };
    },
    watch: {
      externalOpen: {
    ...
    methods: {
      ...
      setPosition() {
        ...
        if (this.position == 'left' || this.position == 'bottom-right' || this.position == 'top-left') {
          this.animationClass = 'uip-scale-in-top-right';
        }
        if (this.position == 'right' || this.position == 'bottom-left' || this.position == 'top-right') {
          this.animationClass = 'uip-scale-in-top';
        }
