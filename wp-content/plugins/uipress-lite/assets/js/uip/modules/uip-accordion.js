    ...
    template:
      '<div>\
          ...
          class="uip-flex uip-cursor-pointer uip-flex-middle uip-flex-center uip-flex-between uip-accordion-title uip-gap-s " :class="returnClasses()">\
            ...
            <div v-if="hasFooterSlot()" @click="open = !open" class="uip-ratio-1-1 uip-icon uip-padding-xxxs uip-accordion-trigger uip-icon-medium uip-text-l uip-line-height-1" type="button" >\
