                ...
                <uip-offcanvas position="right" :style="'padding:0'">
                  ...
                  <template v-slot:content>
                    <div class="uip-max-h-100vh uip-overflow-hidden uip-w-100p">
                      ...
                      <iframe @load="helpLoaded = true" class="uip-h-100p uip-w-100p" src="https://v2-embednotion.com/uipress/UiPress-Documentation-c06fbfd10de2438a9bb1e416028a8d61"></iframe>
                    </div>
                  </template>
                </uip-offcanvas>
