  ...
  return {
    ...
    methods: {
      ...
      fetchThemes() {
        ...
        let URL = 'https://api.uipress.co/templates/list/' + '?sort=newest&filter=ui-template';
    ...
    template: `
      ...
      <div class="uip-position-fixed uip-top-0 uip-left-0 uip-h-viewport uip-w-vw uip-background-black-wash uip-flex uip-flex-center uip-flex-middle uip-fade-in uip-text-normal uip-z-index-1" tabindex="1">
        <div ref="uipmodal" class="uip-background-default uip-border-round uip-border uip-flex uip-flex-column uip-row-gap-m uip-scale-in uip-w-500 uip-z-index-1 uip-transition-all">
          ...
          <template v-else>
            ...
            <!--Step 1 -->
            <div v-if="currentStep == 1" class="uip-flex uip-flex-column uip-row-gap-m uip-padding-s  uip-padding-remove-bottom uip-padding-remove-top uip-fade-in">
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.siteLogo}}</div>
                <image-select :value="setupDetails.logo" :returnData='function(d){ setupDetails.logo = d}'></image-select>
              </div>
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.siteLogoDarkMode}}</div>
                <image-select :value="setupDetails.darkLogo" :returnData='function(d){ setupDetails.darkLogo = d}'></image-select>
              </div>
            </div>
            ...
            <!--Step 4 -->
            <div v-if="currentStep == 4" class="uip-flex uip-flex-column uip-row-gap-m uip-padding-s  uip-padding-remove-bottom uip-padding-remove-top uip-fade-in">
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.appliesTo}}</div>
              ...
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.excludes}}</div>
            ...
            <!--Step 5 -->
            <div v-if="currentStep == 5" class="uip-flex uip-flex-column uip-row-gap-m uip-padding-s  uip-padding-remove-bottom uip-padding-remove-top uip-fade-in">
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.enableLoginTheme}}</div>
                <switch-select :value="setupDetails.enableLoginTheme" :returnData='function(d){ setupDetails.enableLoginTheme = d}'></switch-select>
              </div>
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.loginLogo}}</div>
                <image-select :value="setupDetails.loginLogo" :returnData='function(d){ setupDetails.loginLogo = d}'></image-select>
              </div>
              <div>
                <div class="uip-text-bold uip-margin-bottom-xxs">{{strings.loginBackground}}</div>
                <image-select :value="setupDetails.loginBackground" :returnData='function(d){ setupDetails.loginBackground = d}'></image-select>
              </div>
            </div>
