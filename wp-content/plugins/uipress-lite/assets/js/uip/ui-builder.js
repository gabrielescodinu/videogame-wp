...
import { uip } from './classes/uip.min.js?ver=3.1.11';
import { uipMediaLibrary } from './classes/uip-media-library.min.js?ver=3.1.11';
const uipress = new uip('builder');

///Blocks groups
//Register block settings groups
import * as blockGroups from './blocks/block-settings-groups.min.js?ver=3.1.11';
uipress.register_new_block_groups(blockGroups.fetchGroups());
//Import blocks
import * as elementBlocks from './blocks/elements/loader.min.js?ver=3.1.11';
import * as layoutBlocks from './blocks/layout/loader.min.js?ver=3.1.11';
import * as formBlockOptions from './blocks/inputs/loader.min.js?ver=3.1.11';
import * as dynamicBlocks from './blocks/dynamic/loader.min.js?ver=3.1.11';
import * as analyticsBlocks from './blocks/analytics/loader.min.js?ver=3.1.11';
import * as storeAnalyticsBlocks from './blocks/storeanalytics/loader.min.js?ver=3.1.11';
...
//Dynamic settings
import * as UIPDynamicss from './options/dynamic-settings.min.js?ver=3.1.11';
...
///Block settings
import * as UIPsettings from './options/settings-loader.min.js?ver=3.1.11';
...
import * as UIPthemeStyles from './options/theme-styles.min.js?ver=3.1.11';
...
import * as UIPtemplateSettings from './uibuilder/template-settings-groups.min.js?ver=3.1.11';
...
import * as UIPGlobalSettingsGroups from './uibuilder/global-settings-groups.min.js?ver=3.1.11';
...
///Views
import * as UIbuilderTable from './uibuilder/uip-template-list.min.js?ver=3.1.11';
import * as UIBuilderFramework from './uibuilder/uip-builder-framework.min.js?ver=3.1.11';
import * as UIbuilderSetupWizard from './uibuilder/uip-builder-setup-wizard.min.js?ver=3.1.11';
import * as UIbuilderGlobalSettings from './uibuilder/uip-builder-global-settings.min.js?ver=3.1.11';
import * as UIbuilderBlockSettingsLoader from './uibuilder/uip-settings-loader.min.js?ver=3.1.11';

import * as UIbuilderSettings from './uibuilder/uip-builder-settings.min.js?ver=3.1.11';
import * as UIbuilderPreview from './uibuilder/uip-ui-preview.min.js?ver=3.1.11';
import * as UIbuilderblocksList from './uibuilder/uip-builder-blocks-list.min.js?ver=3.1.11';
import * as UIbuilderPatternsList from './uibuilder/uip-builder-patterns-list.min.js?ver=3.1.11';
import * as UIbuilderDropArea from './uibuilder/uip-builder-drop-area.min.js?ver=3.1.11';
import * as UIbuilderTreeviewDropArea from './uibuilder/uip-treeview-drop-area.min.js?ver=3.1.11';
import * as UIbuilderBlockContainer from './uibuilder/uip-block-container.min.js?ver=3.1.11';
import * as UIbuilderBlockSettings from './uibuilder/uip-block-settings.min.js?ver=3.1.11';
import * as UIbuilderHistory from './uibuilder/uip-builder-history.min.js?ver=3.1.11';
import * as UIbuilderBlockActions from './uibuilder/uip-block-actions.min.js?ver=3.1.11';
import * as UIbuilderLibrary from './uibuilder/uip-template-library.min.js?ver=3.1.11';

import * as UIbuilderVariablesList from './uibuilder/uip-builder-variables.min.js?ver=3.1.11';
import * as UIbuilderSavePattern from './uibuilder/uip-save-pattern.min.js?ver=3.1.11';

//Tool import
import * as UIToolsErrroLog from './tools/uip-php-error-log.min.js?ver=3.1.11';

//modules
import * as UIbuilderDropdown from './modules/uip-dropdown.min.js?ver=3.1.11';
import * as UIbuilderMultiSelect from './modules/uip-multiselect.min.js?ver=3.1.11';
import * as UIbuilderUserMultiSelect from './modules/uip-user-role-multiselect.min.js?ver=3.1.11';
import * as UIbuilderUserSearch from './modules/uip-user-role-search.min.js?ver=3.1.11';

import * as UIbuilderPostTypeMultiSelect from './modules/uip-post-type-select.min.js?ver=3.1.11';
import * as UIbuilderPostMetaMultiSelect from './modules/uip-post-meta-select.min.js?ver=3.1.11';
import * as UIbuilderAccordion from './modules/uip-accordion.min.js?ver=3.1.11';
import * as UIbuilderSwitchToggle from './modules/uip-switch-toggle.min.js?ver=3.1.11';
import * as UIbuilderTooltip from './modules/uip-tooltip.min.js?ver=3.1.11';
import * as UIbuilderChartLoading from './modules/uip-loading-chart.min.js?ver=3.1.11';
import * as UIbuilderOffcanvas from './modules/uip-offcanvas.min.js?ver=3.1.11';
import * as UIbuilderSaveButton from './modules/uip-save-button.min.js?ver=3.1.11';
import * as UIbuilderDynamicList from './modules/uip-dynamic-data-list.min.js?ver=3.1.11';
import * as UIbuilderChart from './modules/uip-chart.min.js?ver=3.1.11';
import * as UIbuilderModal from './modules/uip-modal.min.js?ver=3.1.11';
import * as UIfloatingPanel from './modules/uip-floating-panel.min.js?ver=3.1.12';

//Option components
import * as UIbuilderImageSelect from './options/uip-image-select.min.js?ver=3.1.11';
import * as UIbuilderBackgroundPosition from './options/uip-background-position.min.js?ver=3.1.11';
import * as UIbuilderSwitch from './options/uip-switch-select.min.js?ver=3.1.11';
import * as UIbuilderValueUnits from './options/uip-value-units.min.js?ver=3.1.11';
import * as UIbuilderUnits from './options/uip-units.min.js?ver=3.1.11';
import * as UIbuilderDimensions from './options/uip-dimensions.min.js?ver=3.1.11';
import * as UIbuilderColorSelect from './options/uip-color-select.min.js?ver=3.1.11';
import * as UIbuilderColorPicker from './options/uip-color-picker.min.js?ver=3.1.11';
import * as UIbuilderBorder from './options/uip-border-designer.min.js?ver=3.1.11';
import * as UIbuilderShadow from './options/uip-shadow-designer.min.js?ver=3.1.11';
import * as UIbuilderInput from './options/uip-input.min.js?ver=3.1.11';
import * as UIbuilderNumber from './options/uip-number.min.js?ver=3.1.11';
import * as UIbuilderPostTypes from './options/uip-post-types.min.js?ver=3.1.11';
import * as UIbuilderPostMeta from './options/uip-post-meta.min.js?ver=3.1.11';
import * as UIbuilderParagraphInput from './options/uip-paragraph-input.min.js?ver=3.1.11';
import * as UIbuilderDynamicInput from './options/uip-dynamic-input.min.js?ver=3.1.11';
import * as UIbuilderPadding from './options/uip-padding.min.js?ver=3.1.11';
import * as UIbuilderMargin from './options/uip-margin.min.js?ver=3.1.11';
import * as UIbuilderIconSelect from './options/uip-icon-select.min.js?ver=3.1.11';
import * as UIbuilderInlineIconSelect from './options/uip-inline-icon-select.min.js?ver=3.1.11';
import * as UIbuilderChoiceSelect from './options/uip-choice-select.min.js?ver=3.1.11';
import * as UIbuilderIconChoiceSelect from './options/uip-icon-choice-select.min.js?ver=3.1.11';
import * as UIbuilderTextFormat from './options/uip-text-format.min.js?ver=3.1.11';
import * as UIbuilderDefaultSelect from './options/uip-default-select.min.js?ver=3.1.11';
import * as UIbuilderLinkSelect from './options/uip-link-select.min.js?ver=3.1.11';
import * as UIbuilderBorderRadius from './options/uip-border-radius.min.js?ver=3.1.11';
import * as UIbuilderTabBuilder from './options/uip-tab-builder.min.js?ver=3.1.11';
import * as UIbuilderHiddenMenuItems from './options/uip-hidden-menu-items-select.min.js?ver=3.1.11';
import * as UIbuilderHiddenToolbarItems from './options/uip-hidden-toolbar-items-select.min.js?ver=3.1.11';
import * as UIbuilderEditToolbarItems from './options/uip-edit-toolbar-items.min.js?ver=3.1.11';
import * as UIbuilderEditMenuItems from './options/uip-edit-menu-items.min.js?ver=3.1.11';
import * as UIbuilderResponsive from './options/uip-responsive.min.js?ver=3.1.11';
import * as UIbuilderMultiselectOption from './options/uip-multi-select.min.js?ver=3.1.11';
import * as UIbuilderCodeEditor from './options/uip-code-editor.min.js?ver=3.1.11';
import * as UIbuilderPositionEditor from './options/uip-position-designer.min.js?ver=3.1.11';
import * as UIbuilderSubmitAction from './options/uip-submit-action.min.js?ver=3.1.11';
import * as UIbuilderSelectOptionBuilder from './options/uip-select-option-builder.min.js?ver=3.1.11';
import * as UIbuilderSimpleColorPicker from './options/uip-simple-color-picker.min.js?ver=3.1.11';
import * as UIbuilderArrayList from './options/uip-array-list.min.js?ver=3.1.11';
import * as UIbuilderSelectPostTypes from './options/uip-select-post-types.min.js?ver=3.1.11';
